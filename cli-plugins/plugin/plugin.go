...
func Run(makeCmd func(command.Cli) *cobra.Command, meta cliplugins.Metadata) {
...
func newMetadataSubcommand(plugin *cobra.Command, meta cliplugins.Metadata) *cobra.Command {
